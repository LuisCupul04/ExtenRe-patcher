...
class ApkBundle(files: List<File>) {
    ...
    init {
        ...
        splits = splitList.takeIf { it.isNotEmpty() }?.associateBy { it.config }
    ...
    inner class GlobalResources {
         ...
         */
        fun resolve(type: String, name: String): Int =
        ...
        init {
            ...
            base.resources.also {
                ...
                resTable = resourceIds.table.listPackages().single { pkg -> pkg.id == it.packageBlock!!.id.toByte() }
